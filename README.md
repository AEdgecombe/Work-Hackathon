...
This repository contains a brief overview of a PoC/MVP project developed during a work hackathon. Due to the sensitive nature of the data and internal tooling used, technical implementation details are limited. 
